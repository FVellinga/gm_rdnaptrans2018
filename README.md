...
%self_validation_import(/folders/myfolders/sasuser.v94/files/input/Z001_ETRS89andRDNAP.txt, RDNAP)</i>
</p>

<p>Voorbeeld versie 1:</br>
  <i>%gm_rdnaptrans2018</br>
...
<p>Voorbeeld versie 2:</br>
  ...
  %ETRS89_to_RD_v2(DataSetIn, DataSetOut)</i></p>
  
<p>Voorbeeld versie 3:</br>
  <i>%gm_rdnaptrans2018</br>
  %rdnaptrans2018_ini_v3</br>
  %ETRS89_to_RD_v3(DataSetIn, DataSetOut, RDNAP)</i></p> 
